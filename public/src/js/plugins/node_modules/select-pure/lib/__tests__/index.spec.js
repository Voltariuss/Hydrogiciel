...
describe("SelectPure component", function () {
  ...
  describe("basic", function () {
    ...
    it("toggles on click", function () {
      ...
      var selectNode = document.querySelector("." + mockedClassNames.select);
    ...
    it("selects another value", function () {
      ...
      var selectNode = document.querySelector("." + mockedClassNames.select);
      var options = document.querySelectorAll("." + mockedClassNames.select + " ." + mockedClassNames.option);
    ...
    it("sets position of dropdown according to the height of select", function () {
      ...
      var selectNode = document.querySelector("." + mockedClassNames.select);
      var options = document.querySelectorAll("." + mockedClassNames.select + " ." + mockedClassNames.option);
      var dropdown = document.querySelector("." + mockedClassNames.dropdown);
  ...
  describe("multiselect", function () {
    ...
    it("unselects new option on icon click", function () {
      ...
      var label = document.querySelector("." + mockedClassNames.select + " ." + mockedClassNames.label);
      var selectedLabels = label.querySelectorAll("." + mockedClassNames.selectedLabel);
  ...
  describe("autocomplete", function () {
    ...
    it("doesn't close dropdown on input click", function () {
      ...
      var selectNode = document.querySelector("." + mockedClassNames.select);
      var autocomplete = document.querySelector("." + mockedClassNames.autocompleteInput);
