...
class Controller {
    ...
    {
        var graphique = new graphique(donnes.id, donnees.cibles, donnees.titre, donnees.type, donnees.tempsreel.donnees.mesureX, donnees.mesureY, donnees.dateDebut, donnees.dateFin, 0);
        ...
        return { 'id' : grapique.id, 'chart' : chart };
